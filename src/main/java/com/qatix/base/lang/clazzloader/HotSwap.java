...
public class HotSwap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File fileV2 = new File("/Users/tang/github/JavaBase/target/classes/com/qatix/base/lang/clazzloader/TestClz.class");
        File fileV1 = new File(
                "/Users/tang/github/JavaBase/tmp/TestClz.class");
//        fileV1.delete(); //删除V1版本
    ...
    public static void loadHelloWorld() throws Exception {
        ...
        Class<?> class1 = myLoader
                .findClass("com.qatix.base.lang.clazzloader.TestClz");//类实例
